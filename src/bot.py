...
def create_bot(discord_command_prefix):
    ...
    SAMPLE_COMMAND_MESSAGE_PART = f"Try playing something with `{discord_command_prefix}play <YOUTUBE VIDEO URL>`."
    NO_SESSION_FOUND_MESSAGE = f"You need to have music queued to use this command. {SAMPLE_COMMAND_MESSAGE_PART}"
